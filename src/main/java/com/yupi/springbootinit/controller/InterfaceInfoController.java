...
import com.yupi.springbootinit.model.enums.InterfaceInfoSatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IDRequest idRequest, HttpServletRequest httpServletRequest) {
        ...
        interfaceInfo.setStatus(InterfaceInfoSatusEnum.ONLINE.getValue());
    ...
    public BaseResponse<Boolean> offlineInterfaceInfo(@RequestBody IDRequest idRequest, HttpServletRequest httpServletRequest) {
        ...
        InterfaceInfo interfaceInfo = new InterfaceInfo();
        interfaceInfo.setId(id);
        interfaceInfo.setStatus(InterfaceInfoSatusEnum.OFFLINE.getValue());
        boolean res = interfaceInfoService.updateById(interfaceInfo);
        return ResultUtils.success(res);
    }
    ...
    public BaseResponse<Object> InterfaceInfoInvoke(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest
            , HttpServletRequest request) {
        if (interfaceInfoInvokeRequest == null || interfaceInfoInvokeRequest.getId() <= 1) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        ...
        if (oldInterfaceInfo.getStatus() == InterfaceInfoSatusEnum.OFFLINE.getValue()){
        ...
        Gson gson = new Gson();
        com.example.openApiClientSdk.model.User user =
                gson.fromJson(userRequestParams, com.example.openApiClientSdk.model.User.class);
        openApiClient openApiClient = new openApiClient(accessKey, secretKey);
        String res = openApiClient.getUserNameByPost(user);
        return ResultUtils.success(res);
    }
}